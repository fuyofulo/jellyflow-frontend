export { default as BaseMetadataPanel } from "./BaseMetadataPanel";
...
export { APP_PANELS, getPanelForApp } from "./app-panels";

// Add other app-specific panels as they are created
